# -*- coding: utf-8 -*-
"""
Django settings for phanpy project.
...
class Common(Configuration):
    ...
    DATABASES = values.DatabaseURLValue('postgres://localhost/phanpy')
...
class Production(Common):
    ...
    EMAIL_SUBJECT_PREFIX = values.Value('[phanpy] ', environ_name="EMAIL_SUBJECT_PREFIX")
    EMAIL_USE_TLS = True
